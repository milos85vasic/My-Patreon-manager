...
- Your `.env` file configured with valid Patreon credentials (see [Obtaining Credentials](/docs/obtaining-credentials/#patreon-oauth-credentials))
...
- [Obtaining Credentials](/docs/obtaining-credentials/) — get your Patreon tokens
- [Configuration Reference](/docs/configuration/) — all environment variables
- [Content Generation Guide](/docs/content-generation/) — customize templates and quality thresholds
- [LLMsVerifier Integration](/docs/llms-verifier/) — how content is generated
- [Quickstart Guide](/docs/getting-started/) — full local validation workflow
