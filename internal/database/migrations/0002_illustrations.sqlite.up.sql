-- 0002_illustrations.sqlite.up.sql
-- SQLite-dialect illustrations table. Foreign keys are enforced at the
-- connection level via the _foreign_keys=on pragma (see sqlite.go).
