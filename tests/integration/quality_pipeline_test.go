...
func TestContentGeneration_BudgetExceeded(t *testing.T) {
	...
	_, err := gen.GenerateForRepository(context.Background(), models.Repository{ID: "r1", Service: "github", Owner: "o", Name: "n", HTTPSURL: "u"}, nil, nil)
	assert.Error(t, err)
